      ...
      <div className="max-w-7xl w-full mx-auto grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="space-y-0">
            <motion.h1
              ...
              className="font-display text-[4.5rem] sm:text-[6rem] md:text-[8rem] lg:text-[9rem] leading-none text-ink"
            >
              SOFT
            </motion.h1>
            <motion.h1
              ...
              className="font-display text-[4.5rem] sm:text-[6rem] md:text-[8rem] lg:text-[9rem] leading-none text-sky"
            >
              WARE
            </motion.h1>
            <motion.p
        ...
        >
          ...
          <div className="relative z-10 mx-auto">
            <div className="w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 rounded-2xl overflow-hidden shadow-2xl mx-auto">
              <Image
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.6, duration: 0.6 }}
              className="hidden sm:block absolute -top-6 -left-6 px-4 py-2 bg-white rounded-full shadow-lg border border-sky/20 animate-float"
            >
            ...
            <motion.div
              ...
              className="hidden sm:block absolute -top-2 -right-8 px-4 py-2 bg-white rounded-full shadow-lg border border-candy/20 animate-float-delay-1"
            >
            ...
            <motion.div
              ...
              className="hidden sm:block absolute -bottom-4 right-4 px-4 py-2 bg-white rounded-full shadow-lg border border-sun/20 animate-float-delay-2"
            >
